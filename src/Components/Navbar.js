    ...
    return (
        <>
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="flex flex-wrap items-center justify-between mx-auto px-12">
                    <div class="flex items-center">
                        <img src="https://cdn.shopify.com/s/files/1/2622/4518/files/valka-yoga-logo.png" class="h-20"/>
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">YogaCampers</span>
                    </div>
                    <div className='md:order-2'>
                        {user ? <div className="relative" onClick={() => setToggle(!toggle)}>
                        <img className='h-12 rounded-full' src="https://www.pngmart.com/files/22/User-Avatar-Profile-PNG-Isolated-Transparent.png" alt="" />
                        {toggle && (
