...
const About = () => {
  return (
    <>
      <section className="md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-2xl mx-auto p-5 py-16">
        <h3
        ...
        <div>
          <div className="gap-x-14 lg:mx-0 lg:flex lg:items-center lg:justify-center py-8">
            <div className="mt-14 flex justify-center gap-4 lg:gap-8 lg:justify-start lg:mt-0 lg:pl-0">
              <div className="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                <div className="relative">
                  <img
                    src="https://img.freepik.com/free-photo/full-shot-woman-stretching_23-2149247875.jpg"
                    alt=""
                ...
                <div className="relative">
                  <img
                    src="https://img.freepik.com/free-photo/young-beautiful-blonde-girl-practicing-yoga-outside_176420-839.jpg"
                    alt=""
                    className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                  />
                  <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
              ...
              <div className="w-44 min-h-full hidden md:block">
                <div className="relative h-full">
                  <img
                    src="https://img.freepik.com/free-photo/full-shot-man-sitting-yoga-mat_23-2148717230.jpg"
                    alt=""
              ...
              <div className="lg:mr-auto w-44 flex-none space-y-8 ">
                <div className="relative">
                  <img
                    src="https://img.freepik.com/free-photo/front-view-sportive-woman-looking-away_23-2148297788.jpg"
                    alt=""
                    className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                  />
                  <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                ...
                <div className="relative">
                  <img
                    src="https://img.freepik.com/free-photo/full-shot-smiley-woman-holding-phone_23-2148889623.jpg"
                    alt=""
                    className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                  />
                  <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
            ...
            <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex lg:max-w-[40%]">
              <div className="w-full flex-col justify-center items-start gap-8 flex">
                <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                  <h3 className="text-2xl text-[#D6A944] text-center md:text-left font-caudex">
                    Why Us
                  </h3>
                  <h1 className="mb-6 text-4xl lg:text-5xl text-[#17543E] dark:text-white duration-500 font-semibold font-caudex text-center md:text-left">
                ...
                <div className="w-full flex flex-wrap gap-3 lg:flex-nowrap lg:gap-0 justify-between items-center">
              ...
              <Link
                to="/classes"
                className="w-fit px-4 py-2 md:px-8 md:py-4 border-2 border-[#D6A944] text-[#D6A944] font-medium md:font-semibold rounded-full hover:bg-[#D6A944] duration-500 hover:text-white flex mx-auto md:mr-auto md:ml-0"
              >
                Read More
              </Link>
            </div>
      ...
      <section>
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2
              className="mb-4 text-4xl tracking-tight font-extrabold text-[#D6A944] font-caudex"
              data-aos="fade-up"
              data-aos-once
            >
              Our Team
            ...
            <p
              className="text-[#555F5B] dark:text-[#D9D9D9] duration-500 text-center font-raleway lg:text-lg"
              data-aos="fade-up"
              data-aos-delay="300"
              data-aos-once
            >
              Meet our hardworking team members from all over the world and
              follow their socials for their extraordinary job
            </p>
          </div>
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img
                ...
                alt="Bonnie Avatar"
              />
              <h3 className="mb-1 text-2xl font-extrabold tracking-tight text-[#17543E] font-caudex dark:text-white">
                <p>Bonnie Green</p>
              </h3>
              <p>CEO/Co-founder</p>
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
                  <p className="text-[#39569c] hover:text-gray-900 dark:hover:text-white">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                ...
                <li>
                  <p className="text-[#00acee] hover:text-gray-900 dark:hover:text-white">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                ...
                <li>
                  <p className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                ...
                <li>
                  <p className="text-[#ea4c89] hover:text-gray-900 dark:hover:text-white">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
      ...
      <section>
        <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
          <h2
            className="mb-8 lg:mb-12 text-center text-4xl tracking-tight font-extrabold text-[#D6A944] font-caudex"
            data-aos="fade-up"
            data-aos-once
          >
            Our Longterm Partners
          </h2>
          <div className="grid grid-cols-2 gap-8 text-[#17543E] sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-300 duration-500">
            <p className="flex justify-center items-center">
              <svg
                className="h-9 hover:text-gray-900 dark:hover:text-white hover:scale-110 duration-500"
                viewBox="0 0 125 35"
                fill="currentColor"
            ...
            <p className="flex justify-center items-center">
              <svg
                className="h-8 hover:text-gray-900 dark:hover:text-white hover:scale-110 duration-500"
                viewBox="0 0 151 34"
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <p className="flex justify-center items-center">
              <svg
                className="h-6 hover:text-gray-900 dark:hover:text-white hover:scale-110 duration-500"
                viewBox="0 0 124 21"
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
              >
