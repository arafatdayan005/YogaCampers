...
import { allSelectedClass, deleteSelectedClass, enrollClass } from '../../API/class'
...
function SelectedClasses() {
    ...
    return (
        <>
            <p className='text-center font-bold text-5xl tracking-tight pt-10 font-serif dark:text-white'>My Selected Classes</p>
                                ...
                                data.map((d, i) =>
                                    <tr key={d._id} className="bg-white text-center border-b dark:bg-gray-700 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td className="px-6 py-4">
                                            <button onClick={() => handleDelete(d._id)} type="button">
                                                <img className='w-6' src="https://freepngimg.com/download/trash_can/164880-basket-trash-png-free-photo.png" alt="" />
                                            </button>
                                        </td>
                                        <td className="px-6 py-4">
                                            <button onClick={() => handlePay(d._id)} type="button" className="text-white bg-emerald-500 hover:bg-emerald-600 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center">Pay Now</button>
                                        </td>
                                    </tr>
                                )
                            }
