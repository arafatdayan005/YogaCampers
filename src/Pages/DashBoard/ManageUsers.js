...
import { changeRole, getAllUsers } from '../../API/auth'
...
function ManageUsers() {
    ...
    return (
        <>
            <p className='text-center font-bold text-5xl tracking-tight mt-10 font-serif'>All Users</p>
