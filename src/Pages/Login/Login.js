            ...
            <div className="lg:ms-28 w-full px-4 py-8 sm:px-6 sm:py-16 lg:px-8 lg:py-16 lg:w-96">
                ...
                <form onSubmit={handleLogin}>
                    <div className="relative">
                        ...
                        <label htmlFor="floating_outlined" className="absolute text-md text-green-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-teal-950 px-2 peer-focus:px-2 peer-focus:text-green-500 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Enter Email</label>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <label htmlFor="floating_outlined" className="absolute text-md text-green-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-teal-950 px-2 peer-focus:px-2 peer-focus:text-green-500 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Password</label>
                    </div>

                    <p className='m-0 underline cursor-pointer inline-block dark:text-white' onClick={() => setShow(!show)}>
                        <small>
                            {
                ...
                <p className='text-center dark:text-white'><small>Or Sign in With</small></p>
                ...
                <p className='text-center dark:text-white'><small>Don't have an account? <Link to="/signup"> <span className="text-green-500">Signup</span></Link></small></p>
            </div>
